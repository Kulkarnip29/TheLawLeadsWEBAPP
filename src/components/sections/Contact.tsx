                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                    <div className="space-y-6">
                         ...
                         <Card className="glassmorphism">
                            ...
                            <CardContent>
                                <a href="mailto:info@thelawleads.com" className="text-foreground/90 hover:text-accent transition-colors">info@thelawleads.com</a>
                            </CardContent>
                        </Card>
                         <Card className="glassmorphism">
                            <CardHeader className="flex flex-row items-center gap-4">
                            ...
                            <CardContent>
                                <a href="tel:+919876543210" className="text-foreground/90 hover:text-accent transition-colors">+91 98765 43210</a>
                            </CardContent>
                        </Card>
                    </div>
