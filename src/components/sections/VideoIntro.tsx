        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              <Badge
                variant="outline"
                className="border-accent text-accent px-4 py-1.5 uppercase tracking-widest text-[10px] font-black"
              >
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-5">
              <Button
                asChild
                size="lg"
                className="bg-red-600 hover:bg-red-700 text-white font-bold h-14 px-8 rounded-2xl shadow-xl shadow-red-600/20 group transition-all"
              >
                <Link
                  href={videoSection.youtubeChannel}
                  target="_blank"
              ...
              <Button
                ...
                size="lg"
                asChild
                className="border-primary/20 text-primary hover:bg-primary/5 h-14 px-8 rounded-2xl font-bold"
              >
                <a
            ...
            <div className="pt-4 flex items-center justify-center lg:justify-start gap-4 text-xs font-bold text-foreground/40 uppercase tracking-widest">
              <span className="flex items-center gap-1.5">
                <Play className="w-3 h-3 text-accent" /> 1'st Lecture Free
              </span>
